    ...
    return (
        <div className='w-full relative'>
            ...
            className={`flex items-center w-[60%] border h-10 md:h-12 px-2 rounded-xl pl-3 transition-all duration-300 ${selected ? "bg-white dark:bg-gray-700 border-gray-300 dark:border-gray-600" : "bg-gray-200 dark:bg-gray-700 border-gray-300 dark:border-gray-600"}`}>
                ...
                className={`w-[100%] p-1 ml-2 md:text-xl rounded-full text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400 focus:placeholder-transparent dark:focus:placeholder-transparent outline-none transition-all duration-300 ${selected ? "bg-white dark:bg-gray-700" : "bg-gray-200 dark:bg-gray-700"}`}
                />
