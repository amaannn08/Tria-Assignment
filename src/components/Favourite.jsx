    ...
    return (
        <div >
            <div onClick={focusHandler}
                className='w-[40%] md:w-[10%] flex flex-row items-center gap-2 mt-4 ml-2 cursor-pointer'>
                <Star className='text-gray-300 fill-gray-300 w-5 h-4'/>
                <div className='flex flex-row items-center'>
                    <h1 className='text-gray-300'>Favourites</h1>
                    <h1 className='text-gray-300'>({contacts.filter(c=>c.favourite==="Yes").length})</h1>
                </div>
